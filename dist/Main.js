...
Elm.Nav.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "GoSummary": return _U.update(model,{page: Summary});
         case "GoRegister": return _U.update(model,{page: Register});
         default: return _U.update(model,{regCount: _p0._0});}
   });
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.li,
                      ...
                      _U.list([]),
                      _U.list([A2($Html.a,
                      _U.list([$Html$Attributes.href("#"),onNavClick(GoSummary)]),
...
Elm.App.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "UrlParam": var urlElems = A2($List.filter,
         ...
         case "MetaReceived": if (_p2._0.ctor === "Ok") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {navbar: A2($Nav.update,
                        $Nav.CountData(_p2._0._0),
                        model.navbar)})
                        ,_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{msg: $Common.errorHandler(_p2._0._0)})
                        ,_1: $Effects.none};
              }
         default: return {ctor: "_Tuple2"
