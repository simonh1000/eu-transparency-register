...
Elm.App.make = function (_elm) {
   ...
   var footerDiv = function (address) {
      ...
      _L.fromArray([A2($Html.span,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Simon Hampton, 2015")]))
                   ,A2($Html.button,
   ...
   var getMeta = $Effects.task($Task.map(MetaReceived)($Task.toResult(A2($Http.get,
   A2($Json$Decode.map,
   $Basics.toString,
   A2($Json$Decode._op[":="],
   "count",
   ...
   model) {
      return function () {
         ...
         var switchSummary = function () {
            var _ = A2($Summary$Summary.update,
            $Summary$Summary.Activate,
            model.summary);
            var sumEffects = function () {
               switch (_.ctor)
               {case "_Tuple2": return _._1;}
               _U.badCase($moduleName,
               "on line 62, column 35 to 80");
            }();
            var navModel = A2($Nav.update,
            $Nav.GoSummary,
            model.navbar);
            ...
            {case "Help":
               ...
               switch (action._0.ctor)
                 {case "Err":
                    return {ctor: "_Tuple2"
                           ,_0: _U.replace([["msg"
                                            ,$Common.errorHandler(action._0._0)]],
                           model)
                           ,_1: $Effects.none};
                    case "Ok":
                    return {ctor: "_Tuple2"
               ...
               return function () {
                    switch (action._0.ctor)
                    {case "GoRegister":
                       return switchRegister(action._0._0);
                       case "GoSummary":
                       return switchSummary;}
                    _U.badCase($moduleName,
                    "between lines 103 and 123");
                 }();
               case "RegisterAction":
               return function () {
                    var $ = A2($Register.update,
               ...
               return function () {
                    ...
                    action._0));
                    return function () {
                       var _v13 = $List.head(urlElems);
                       switch (_v13.ctor)
                       {case "Just": switch (_v13._0)
                            {case "summary":
                               return switchSummary;}
                            break;}
...
Elm.Entries.Entries.make = function (_elm) {
   ...
   var updateUrl = function (displayed) {
      return $Effects.task($Task.map(NoOp)($Task.toMaybe($History.replacePath(combineIds(displayed)))));
   };
   var EntryAction = F2(function (a,
   b) {
      ...
      return function () {
         ...
         _L.fromArray([A2($Html.header,
                      ...
                      _L.fromArray([A2($Html.h2,
                                   _L.fromArray([]),
                                   _L.fromArray([$Html.text("Summary of Transparency Register entries")]))
                                   ,A2($Html.button,
                                   _L.fromArray([A2($Html$Events.onClick,
                                                address,
                                                CloseAll)
                                                ,$Html$Attributes.$class("btn btn-default btn-xs closeAll")]),
                                   _L.fromArray([$Html.text("Close All")]))]))
                      ,$Html.div(_L.fromArray([$Html$Attributes.$class("eContainer")]))(A2($List.map,
                      viewMapper,
                      model.displayed))]));
      }();
   });
   var EntryReceived = function (a) {
      return {ctor: "EntryReceived"
             ,_0: a};
   };
   ...
   model) {
      return function () {
         var insertEntry = function (id) {
            return function () {
               var newDisplayed = A2($List._op["::"],
               id,
               model.displayed);
               return {ctor: "_Tuple2"
                      ,_0: _U.replace([["displayed"
                                       ,newDisplayed]],
                      model)
         ...
         return function () {
            ...
            {case "CloseAll":
               ...
               switch (action._0.ctor)
                 {case "Err":
                    ...
                    case "Ok": return function () {
                         var $ = insertEntry(action._0._0.id),
                         newModel = $._0,
                         newEffects = $._1;
                         return {ctor: "_Tuple2"
                                ,_0: _U.replace([["cache"
                                                 ,A3($Dict.insert,
                                                 action._0._0.id,
                                                 $Entries$Entry.init(action._0._0),
                                                 newModel.cache)]
                                                ,["message",action._0._0.id]],
                                newModel)
                                ,_1: newEffects};
                      }();}
                 break;
               ...
               return A2($List.member,
                 action._0,
                 model.displayed) ? {ctor: "_Tuple2"
                                    ,_0: model
                                    ,_1: $Effects.none} : A2($Dict.member,
                 action._0,
                 model.cache) ? insertEntry(action._0) : {ctor: "_Tuple2"
                                                         ,_0: model
                                                         ,_1: loadEntry(action._0)};
               case "NoOp":
               return {ctor: "_Tuple2"
                      ,_0: model
                      ,_1: $Effects.none};}
            _U.badCase($moduleName,
            "between lines 59 and 99");
         }();
      }();
   });
   var GetEntryFor = function (a) {
      return {ctor: "GetEntryFor"
             ,_0: a};
   };
   var init = {_: {}
              ,cache: $Dict.empty
              ,displayed: _L.fromArray([])
              ,message: ""};
   ...
   _elm.Entries.Entries.values = {_op: _op
                                 ,init: init
                                 ,update: update
                                 ,view: view
                                 ,updateUrl: updateUrl
...
Elm.Entries.Entry.make = function (_elm) {
   ...
   if (_elm.Entries.Entry.values)
   return _elm.Entries.Entry.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Entries.Entry",
   $Basics = Elm.Basics.make(_elm),
   $Entries$EntryDecoder = Elm.Entries.EntryDecoder.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   var viewMore = function (model) {
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([A2($Html.h4,
                                ...
                                ,A2($Html.p,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text(model.data.memberships)]))]))]));
   };
   var viewMeta = F2(function (address,
   entry) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("row")]),
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([A2($Html.h4,
                                ...
                                ,A2($Html.p,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text($Basics.toString(entry.noFTEs))]))]))]));
   });
   var update = F2(function (action,
   model) {
      return function () {
         switch (action.ctor)
         {case "Expand":
            return _U.replace([["expand"
                               ,$Basics.not(model.expand)]],
              model);
            case "Tick":
            return _U.replace([["entry"
                               ,false]],
              model);}
         _U.badCase($moduleName,
   ...
   model) {
      return A2($Html.div,
      _L.fromArray([animationStyles(model.entry)]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Html.h3,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(model.data.orgName)]))
                   ,A2($Html.button,
                   _L.fromArray([$Html$Attributes.$class("btn btn-default btn-xs closeEntry")
                                ,A2($Html$Events.onClick,
                                address,
                                Close)]),
                   ...
                   ,A2($Html.button,
                   _L.fromArray([$Html$Attributes.$class("btn btn-default btn-xs expandEntry")
                                ,A2($Html$Events.onClick,
                                address,
                                Expand)]),
                   _L.fromArray([$Html.text("v")]))
                   ,viewMore(model)]))]));
   });
   var Tick = function (a) {
      return {ctor: "Tick",_0: a};
   ...
   _elm.Entries.Entry.values = {_op: _op
                               ,init: init
                               ,update: update
                               ,view: view
                               ,Model: Model
...
Elm.Entries.EntryDecoder.make = function (_elm) {
   ...
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Entries.EntryDecoder",
   $Basics = Elm.Basics.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var costs = $Json$Decode.oneOf(_L.fromArray([A2($Json$Decode.map,
                                               $Basics.toString,
                                               A2($Json$Decode._op[":="],
                                               "costsAbsolute",
                                               $Json$Decode.$int))
                                               ...
                                               "costEst",
                                               $Json$Decode.string)]));
   var maybeMemberships = $Json$Decode.oneOf(_L.fromArray([A2($Json$Decode._op[":="],
                                                          "memberships",
                                                          $Json$Decode.string)
                                                          ,$Json$Decode.succeed("None")]));
   var init = F8(function (i,
   o,
   h,
   e,
   c,
   ...
   _elm.Entries.EntryDecoder.values = {_op: _op
                                      ,init: init
...
Elm.Filters.Filters.make = function (_elm) {
   ...
   var GetMatch = function (a) {
      return {ctor: "GetMatch"
             ,_0: a};
   };
   var submitRow = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("row")]),
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(filters2String(model))]))]))]));
   });
   var Budget = function (a) {
      return {ctor: "Budget"
             ,_0: a};
   };
   var budgetView = F2(function (address,
   val) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Html.h4,
   ...
   var FTE = function (a) {
      return {ctor: "FTE",_0: a};
   };
   var fteView = F2(function (address,
   val) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Html.h4,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Staff")
                                ,A2($Html.span,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text(A2($Basics._op["++"],
                                " (at least ",
   ...
   var sectionView = function (address) {
      ...
      _L.fromArray([A2($Html.h4,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Type of org")]))
                   ,$Html.select(_L.fromArray([$Html$Attributes.$class("form-control")
                                              ,A3($Html$Events.on,
                                              "change",
                                              A2($Json$Decode.map,
                                              Section,
                                              $Html$Events.targetValue),
                                              $Signal.message(address))]))(A2($List.map,
                   function ($) {
                      return $Html.option(_L.fromArray([]))($List.repeat(1)($Html.text($)));
                   },
   ...
   model) {
      ...
      _L.fromArray([A2($Html.h4,
                   ...
                   _L.fromArray([$Html$Attributes.type$("text")
                                ...
                                $Html$Events.targetValue),
                                $Signal.message(address))]),
                   _L.fromArray([$Html.text(model.search)]))]));
   });
   var view = F2(function (address,
   model) {
      return A2($Html.div,
   ...
   _elm.Filters.Filters.values = {_op: _op
                                 ,init: init
                                 ,update: update
                                 ,view: view
                                 ,Model: Model
...
Elm.Filters.Section.make = function (_elm) {
   ...
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Filters.Section",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var subsections = _L.fromArray(["All"
...
Elm.Matches.Matches.make = function (_elm) {
   ...
   var viewMatch = F2(function (address,
   match) {
      return A2($Html.p,
      _L.fromArray([A2($Html$Events.onClick,
      address,
      GetEntry(match.id))]),
      _L.fromArray([$Html.text(match.orgName)]));
   });
   var viewFilterResults = F2(function (address,
   model) {
      return A2($Html.div,
   ...
   var viewRecents = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.id("matches")
                   ,$Html$Attributes.$class("col-xs-12 col-sm-4")]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("recent entries")]),
                   _L.fromArray([A2($Html.h2,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text(A2($Basics._op["++"],
   ...
   model) {
      return function () {
         var _v2 = model.resultsType;
         switch (_v2.ctor)
         {case "FilterMatches":
            return A2(viewFilterResults,
              address,
              model);
            case "Recents":
            return A2(viewRecents,
              address,
              model);}
         _U.badCase($moduleName,
   ...
   var RecentsData = function (a) {
      return {ctor: "RecentsData"
             ,_0: a};
   };
   var getRecents = $Effects.task($Task.map(RecentsData)($Task.toResult(A2($Http.get,
   $Matches$MatchesDecoder.recentsDecoder,
   "/api/register/recents"))));
   var GetRecents = {ctor: "GetRecents"};
   var MatchesData = function (a) {
      return {ctor: "MatchesData"
             ,_0: a};
   };
   var getMatches = function (model) {
      return function () {
         ...
         "All") ? _L.fromArray([]) : _L.fromArray([{ctor: "_Tuple2"
                                                   ,_0: "section"
                                                   ,_1: model.section}]));
         return $Effects.task($Task.map(MatchesData)($Task.toResult(A2($Http.get,
         ...
         {case "GetMatchFor":
            ...
            switch (action._0.ctor)
              {case "Err":
                 ...
                 case "Ok":
                 return {ctor: "_Tuple2"
                        ,_0: _U.replace([["resultsType"
                                         ,Recents]
                                        ,["newstuff",action._0._0]],
                        model)
                        ,_1: $Effects.none};}
              break;
            case "SetRegister":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: $Effects.none};}
         _U.badCase($moduleName,
         "between lines 51 and 84");
      }();
   });
   _elm.Matches.Matches.values = {_op: _op
                                 ,init: init
                                 ,update: update
                                 ,view: view
                                 ,Model: Model
...
Elm.Matches.MatchesDecoder.make = function (_elm) {
   ...
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Matches.MatchesDecoder",
   $Basics = Elm.Basics.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var initNew = F2(function (e,
   u) {
      return {_: {}
             ,entries: e
             ,updates: u};
   });
   var NewStuff = F2(function (a,
   b) {
      return {_: {}
             ,entries: a
             ,updates: b};
   });
   var init = F2(function (i,o) {
      return {_: {}
             ,id: i
             ,orgName: o};
   });
   ...
   _elm.Matches.MatchesDecoder.values = {_op: _op
                                        ,initNew: initNew
         ...
         _L.fromArray([A2($Html.div,
                      ...
                      _L.fromArray([A2($Html.li,
                                   ...
                                   _L.fromArray([$Html$Attributes.href("#")
                                                ,onNavClick(GoRegister(_L.fromArray([])))]),
                                   _L.fromArray([$Html.text($Basics.toString(Register))]))]))
                                   ,A2($Html.li,
                                   _L.fromArray([]),
                                   _L.fromArray([A2($Html.a,
                                   _L.fromArray([$Html$Attributes.href("#")
                                                ,onNavClick(GoRegister(_L.fromArray(["recent"])))]),
...
Elm.Register.make = function (_elm) {
   ...
   var updateUrl = function (displayed) {
      return $Effects.task($Task.map(NoOp)($Task.toMaybe($History.replacePath(displayed))));
   };
         ...
         {case "Activate":
            return function () {
                 ...
                 {case "::":
                    switch (action._0._0)
                      {case "recent":
                         switch (action._0._1.ctor)
                           {case "[]": return function () {
                                   var _ = A2($Matches$Matches.update,
                                   $Matches$Matches.GetRecents,
                                   model.matches);
                                   var newEffects = function () {
                                      switch (_.ctor)
                                      {case "_Tuple2": return _._1;}
                                      _U.badCase($moduleName,
                                      "on line 63, column 25 to 72");
                                   }();
                                   return {ctor: "_Tuple2"
                                          ,_0: model
                                          ,_1: $Effects.batch(_L.fromArray([A2($Effects.map,
                    ...
                    return {ctor: "_Tuple2"
                           ,_0: _U.replace([["matches"
                                            ,$Basics.fst(A2($Matches$Matches.update,
                                            $Matches$Matches.SetRegister,
                                            model.matches))]],
                           model)
                           ,_1: updateUrl("default")};}
                 return function () {
...
Elm.Summary.Summary.make = function (_elm) {
               ...
               {case "_Tuple3":
                  return function () {
                       ...
                       3.0e-2) < 0 ? {ctor: "_Tuple3"
                                     ,_0: _v4._0 + normBudget
                                     ,_1: _v4._1 + normCount
                                     ,_2: _v4._2} : {ctor: "_Tuple3"
                                                    ,_0: _v4._0
                                                    ,_1: _v4._1
                                                    ,_2: A2($List._op["::"],
                                                    _U.replace([["count"
   ...
   var loadSummary = $Effects.task($Task.map(SummaryData)($Task.toResult(A2($Http.get,
   $Summary$SummaryDecoder.listSummaryDecoder,
   "/api/register/summary"))));
   var CountryData = function (a) {
      return {ctor: "CountryData"
             ,_0: a};
   };
   ...
   var init = {_: {}
              ,countries: _L.fromArray([])
              ,interests: _L.fromArray([])
              ,msg: ""
   ...
   model) {
      return function () {
         ...
         _L.fromArray([A2($Html.div,
                      ...
                      _L.fromArray([{ctor: "_Tuple2"
                                    ,_0: "border"
                                    ,_1: "none"}]))($Chart.colours(_L.fromArray(["#5DA5DA"
                                                                                ,"#FAA43A"
                                                                                ,"#60BD68"
                                                                                ,"#F17CB0"
                                                                                ,"#B2912F"
                                                                                ...
                                                                                ,"#F15854"
                                                                                ,"#BF69B1"
                                                                                ,"#4D4D4D"]))($Chart.addValueToLabel($Chart.title("Corporate registrees by HQ Country")(A2($Chart.pie,
                      A2($List.map,
                      function (_) {
                         return _.count;
                      },
                      ...
                      _L.fromArray([$Chart.toHtml(A2($Chart.updateStyles,
                                   ...
                                   _L.fromArray([{ctor: "_Tuple2"
                                                 ...
                                                 ,_1: "none"}]))($Chart.colours(_L.fromArray(["#5DA5DA"
                                                                                             ...
                                                                                             ,"#F15854"
                                                                                             ,"#BF69B1"
                                                                                             ,"#4D4D4D"]))($Chart.title(_U.eq(model.sectionMeasure,
                                   Count) ? "Number of registrees per sub-section" : "Lobby spend per sub-section")(A2($Chart.pie,
                                   _U.eq(model.sectionMeasure,
                                   Count) ? countModel : budgetModel,
                                   labels)))))
                                   ,A2($Html.div,
                                   _L.fromArray([$Html$Attributes.$class("toggleContainer")]),
                                   _L.fromArray([A2($Html.button,
                                   _L.fromArray([A2($Html$Events.onClick,
                                   address,
                                   Animate)]),
                                   _L.fromArray([$Html.text(_U.eq(model.sectionMeasure,
                                   Count) ? "Switch to lobby spend" : "Switch to no. registrees")]))]))
                                   ,A2($Html.div,
                                   _L.fromArray([$Html$Attributes.$class("interests")]),
                                   _L.fromArray([$Chart.toHtml(A2($Chart.updateStyles,
                                   "container",
                                   _L.fromArray([{ctor: "_Tuple2"
                                                 ,_0: "border"
                                                ...
                                                ,{ctor: "_Tuple2"
                                                 ,_0: "border-top"
                                                 ,_1: "3px solid black"}]))($Chart.title("Number of registrants expressing interest in subject")(A2($Chart.hBar,
                                   A2($List.map,
                                   function ($) {
...
Elm.Summary.SummaryDecoder.make = function (_elm) {
   ...
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Summary.SummaryDecoder",
   $Basics = Elm.Basics.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Json$Decode.string),
   summaryItemDecoder));
   _elm.Summary.SummaryDecoder.values = {_op: _op
                                        ,Interests: Interests
                                        ,Sections: Sections
                                        ,Countries: Countries
                                        ,Interest: Interest
